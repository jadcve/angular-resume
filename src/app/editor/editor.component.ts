...
export class EditorComponent implements OnInit {
 ...
 [
   ...
   "Frameworks: Laravel, Bootstrap, Cake PHP.",
   "APIGEE- Edge",
   "Cloud: AWS, Azure, GCP",
   "Manejador de contenido: WordPress",
   "Manejo de Bases de Datos (SQL): MySQL, PgSQL, SQLServer",
   ...
   "HTML5, CSS3",
   "Manejo de control de versiones GITHUB, GITLAB, BITBUCKET",
   ...
   "Acceso a conexiones remotas",
   "Manejo de IDE's de desarrollo: Eclipse, NetBeans, RubyMine, PHPStorm, Cloud9",
